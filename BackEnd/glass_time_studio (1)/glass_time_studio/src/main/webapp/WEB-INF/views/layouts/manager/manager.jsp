...
<body>
  ...
  <div id="container">
    <fieldset>
      ...
      <button style="display: block; margin:20px auto;" type="button"><a href="/viewAllOrders">주문 관리</a></button>
      ...
      <button style="display: block; margin:20px auto;" type="button"><a href="#">수강생 후기 관리</a></button>
